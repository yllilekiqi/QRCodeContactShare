...
/**
 * Created by Gentrit on 03/07/2017.
 */

public abstract class AbsRuntimePermissions extends Activity {
    ...
    public void requestAppPermissions(final String[]requestedPermissions, final int stringId, final int requestCode) {
        ...
        if (permissionCheck!=PackageManager.PERMISSION_GRANTED) {
            if(showRequestPermissions) {
                Snackbar.make(findViewById(android.R.id.content), stringId, Snackbar.LENGTH_INDEFINITE).setAction("LEJO", new View.OnClickListener() {
                    @Override
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if( (grantResults.length > 0) && PackageManager.PERMISSION_GRANTED == permissionCheck) {
            ...
            Snackbar.make(findViewById(android.R.id.content),
                    ...
                    Snackbar.LENGTH_INDEFINITE).setAction("LEJO", new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent();
